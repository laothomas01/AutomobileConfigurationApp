 ...
 * Key Notes:
 * <p>
 * Other.Animal is an abstract class with:
 * SHARED attributes:
 * -name
 * -lifeExpectancy
 * Abstract methods:
 ...
 * -protectOwner()
 * <p>
 * Other.Dog and Other.Cat ARE Animals implement remember() and protectOwner()
 * <p>
 * Other.Cat can climb() but Other.Dog cannot.
 * <p>
 * Other.Dog can think() but Other.Cat cannot.
 * <p>
 * <p>
...
//        Other.Dog dog = new Other.Dog("Jack", 16);
//        Other.Cat cat = new Other.Cat("Joe", 20);
//
//        System.out.println("Other.Dog:" + dog);
//        System.out.println("Other.Cat:" + cat);
//
//        dog.remember();
//        dog.protectOwner();
//        Learn dl = dog;
