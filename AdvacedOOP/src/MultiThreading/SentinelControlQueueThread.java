...
public class SentinelControlQueueThread extends Thread {
	public SentinelControlQueueThread(String name) {
		super(name);
	}
...
class Program5 {
	public static void main(String[] args) {
		new SentinelControlQueueThread("foo").start();
		new SentinelControlQueueThread("bar").start();
	}
}